    ...
    public class ProductListViewModel : BaseViewModel
    {
        ...
        private ObservableCollection<Product> GetProducts()
        {
            return new ObservableCollection<Product>
            {
                ...
                new Product { Name = "Ha-Ra Cleaning Cloth - Star", Category = "Cleaning", Price = 29395f, StockLevel = 50, Image = "Clean4.jpg", Description = "The Ha-Ra® Star Cloth is a polishing and cleaning cloth. SIZE: 38 x 38 cm"},
